...
Use these cases to test animal identity, coat, markings, proportions, pose, and subject-count preservation. Never add an owner or another animal unless explicitly requested.

## Case 1: Dog portrait

Input traits:

- one dog facing or looking near the camera
- visible ears, muzzle, coat, and collar

Preserve breed characteristics, face structure, ear position, coat color, markings, expression, collar, and pose.
...
## Case 2: Cat on a chair

Input traits:

- one cat interacting with a chair
- clear body curl, paw placement, and tail position

Preserve markings, eye color when visible, body proportions, chair relationship, paw placement, and tail.
...
- exactly two pets
- clear size, spacing, and interaction relationship

Preserve each animal separately: species or breed, markings, scale, pose, and spatial relationship. Output exactly two pets.
...
Animal identity is more than species. Markings, coat distribution, ears, muzzle, tail, proportions, and pose must remain recognizable.
