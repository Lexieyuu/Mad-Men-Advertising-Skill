...
Use these cases to test structural fidelity and genuine illustration conversion. The result must preserve defining geometry and must not be only a vintage color filter.

## Case 1: Modern office tower

Input traits:

- distinctive facade grid
- recognizable massing and roofline
- strong vertical perspective

Preserve the tower's silhouette, facade rhythm, floor spacing, roofline, camera angle, and neighboring structural relationships.
...
## Case 2: Historic facade

Input traits:

- repeated windows or arches
- distinctive entrance
- visible masonry or ornament

Preserve window count and rhythm when legible, entrance placement, major ornament, proportions, and viewpoint.
...
## Case 3: Landmark with skyline context

Input traits:

- one primary landmark
- surrounding skyline establishes scale and location

Preserve the landmark's outline, placement, scale relationship, horizon, and camera direction.
...
Check silhouette, geometry, viewpoint, structural rhythm, and landmark identity before evaluating style. If those fail, regenerate even if the artwork looks period-correct.
