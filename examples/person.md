...
Use these cases to test identity, pose, carried-object, and subject-count preservation. Never add a second person, a background figure, a person in a poster, a mannequin, or a reflected figure.

## Case 1: Mirror selfie with a phone

Input traits:

- one person
- phone partially covers the face
- asymmetric arm position
- modern indoor background

Preserve the exact face, visible features, hairstyle, expression, phone, hand position, camera relationship, body lean, crop, and count.
...
## Case 2: Seated portrait

Input traits:

- one seated person
- recognizable chair or sofa
- clear head angle and hand placement

Preserve the relationship between the body, hands, seat, and camera.
...
## Case 3: Full-body standing figure
...
Preserve proportions, stance, foot position, head angle, clothing identity, and accessory relationship.
...
Identity and pose are pass/fail gates. Do not accept an attractive result that depicts a merely similar person.
